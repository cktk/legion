...
CREATE TABLE `act_evt_log` (
  ...
  `create_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `update_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`LOG_NR_`)
...
-- ----------------------------
BEGIN;
INSERT INTO `act_ge_property` (`NAME_`, `VALUE_`, `REV_`, `create_id`, `update_id`) VALUES ('next.dbid', '1', 1, NULL, NULL);
INSERT INTO `act_ge_property` (`NAME_`, `VALUE_`, `REV_`, `create_id`, `update_id`) VALUES ('schema.history', 'create(5.22.0.0)', 1, NULL, NULL);
INSERT INTO `act_ge_property` (`NAME_`, `VALUE_`, `REV_`, `create_id`, `update_id`) VALUES ('schema.version', '5.22.0.0', 1, NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `address_area` (`id`, `code`, `name`) VALUES (1, '10000', '岱岳区');
INSERT INTO `address_area` (`id`, `code`, `name`) VALUES (2, '10001', '高新区');
INSERT INTO `address_area` (`id`, `code`, `name`) VALUES (3, '10002', '景区');
INSERT INTO `address_area` (`id`, `code`, `name`) VALUES (4, '10003', '徂汶景区');
COMMIT;
...
CREATE TABLE `address_town` (
  ...
  `code` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `name` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  `areacode` varchar(100) COLLATE utf8_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_bin;
...
-- ----------------------------
BEGIN;
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (1, '10000', '山口镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (2, '10001', '角峪镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (3, '10002', '满庄镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (4, '10003', '大汶口镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (5, '10004', '夏张镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (6, '10005', '道朗镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (7, '10006', '祝阳镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (8, '10007', '马庄镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (9, '10008', '范镇', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (10, '10009', '粥店街道', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (11, '10010', '天平街道', '10000');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (12, '10011', '北集坡', '10001');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (13, '10012', '房村', '10001');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (14, '10013', '良庄', '10001');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (15, '10014', '大津口乡', '10002');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (16, '10015', '黄前镇', '10002');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (17, '10016', '下港乡', '10002');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (18, '10017', '化马湾', '10003');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (19, '10018', '天宝', '10003');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (20, '10019', '徂徕镇', '10003');
INSERT INTO `address_town` (`id`, `code`, `name`, `areacode`) VALUES (21, '10020', '徂徕山林场', '10003');
COMMIT;
...
CREATE TABLE `t_act_node` (
  ...
  `type` tinyint(1) DEFAULT NULL,
  `relate_id` bigint unsigned DEFAULT NULL,
  `create_id` varchar(64) DEFAULT NULL,
  `update_id` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
-- ----------------------------
-- Table structure for t_datasource_conf
-- ----------------------------
...
INSERT INTO `t_dict` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `title`, `type`, `sort_order`, `create_id`, `update_id`) VALUES (79717732567748608, 'admin', '2018-11-27 13:42:10', 0, 'admin', '2018-11-27 13:42:10', '', '流程节点类型', 'process_node_type', 4.00, NULL, NULL);
INSERT INTO `t_dict` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `title`, `type`, `sort_order`, `create_id`, `update_id`) VALUES (81843858882695168, 'admin', '2018-12-03 10:30:38', 0, 'admin', '2018-12-03 10:30:49', '', '优先级', 'priority', 5.00, NULL, NULL);
INSERT INTO `t_dict` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `title`, `type`, `sort_order`, `create_id`, `update_id`) VALUES (82236987314016256, 'admin', '2018-12-04 12:32:47', 0, 'admin', '2018-12-04 12:32:47', '', '业务表', 'business_table', 6.00, NULL, NULL);
INSERT INTO `t_dict` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `title`, `type`, `sort_order`, `create_id`, `update_id`) VALUES (82236987314016257, 'admin', '2018-12-04 12:32:47', 0, 'admin', '2018-12-04 12:32:47', '', '业务表单路由', 'business_form', 7.00, NULL, NULL);
INSERT INTO `t_dict` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `title`, `type`, `sort_order`, `create_id`, `update_id`) VALUES (99020862912466944, 'admin', '2019-01-19 20:05:54', 0, 'admin', '2019-01-19 20:06:10', '', '请假类型', 'leave_type', 8.00, NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (75158227712479232, 'admin', '2018-11-14 23:44:19', 0, 'admin', '2019-04-01 23:53:13', '', 75135930788220928, 0.00, 0, '男', '男', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (75159254272577536, 'admin', '2018-11-14 23:48:24', 0, 'admin', '2019-04-01 23:53:17', '', 75135930788220928, 1.00, 0, '女', '女', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (75159898425397248, 'admin', '2018-11-14 23:50:57', 0, 'admin', '2019-04-01 23:53:22', '', 75135930788220928, 2.00, -1, '保密', '保密', NULL, NULL, NULL, NULL);
...
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (79717808262352896, 'admin', '2018-11-27 13:42:28', 0, 'admin', '2018-11-27 13:42:28', '', 79717732567748608, 0.00, 0, '开始节点', '0', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (79717858308788224, 'admin', '2018-11-27 13:42:40', 0, 'admin', '2018-11-27 13:42:40', '', 79717732567748608, 1.00, 0, '审批节点', '1', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (79717920061526016, 'admin', '2018-11-27 13:42:54', 0, 'admin', '2018-12-08 20:35:39', '', 79717732567748608, 2.00, 0, '结束节点', '2', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (81843987719131136, 'admin', '2018-12-03 10:31:08', 0, 'admin', '2018-12-03 10:31:08', '', 81843858882695168, 0.00, 0, '普通', '0', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (81844044015079424, 'admin', '2018-12-03 10:31:22', 0, 'admin', '2018-12-03 10:31:22', '', 81843858882695168, 1.00, 0, '重要', '1', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (81844100705292288, 'admin', '2018-12-03 10:31:35', 0, 'admin', '2018-12-03 10:31:35', '', 81843858882695168, 2.00, 0, '紧急', '2', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (82237106587439104, 'admin', '2018-12-04 12:33:15', 0, 'admin', '2018-12-04 12:33:15', '', 82236987314016256, 0.00, 0, '请假申请表', 't_leave', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (82237106587439105, 'admin', '2018-12-04 12:33:15', 0, 'admin', '2018-12-04 12:33:15', '', 82236987314016257, 0.00, 0, '请假申请表', 'leave', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99020985985929216, 'admin', '2019-01-19 20:06:23', 0, 'admin', '2019-04-01 23:55:48', '', 99020862912466944, 0.00, 0, '年假', '年假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021020739932160, 'admin', '2019-01-19 20:06:32', 0, 'admin', '2019-04-01 23:55:52', '', 99020862912466944, 1.00, 0, '事假', '事假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021195566911488, 'admin', '2019-01-19 20:07:13', 0, 'admin', '2019-04-01 23:55:56', '', 99020862912466944, 2.00, 0, '病假', '病假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021242476007424, 'admin', '2019-01-19 20:07:24', 0, 'admin', '2019-04-01 23:56:01', '', 99020862912466944, 3.00, 0, '调休', '调休', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021300730695680, 'admin', '2019-01-19 20:07:38', 0, 'admin', '2019-04-01 23:56:05', '', 99020862912466944, 4.00, 0, '产假', '产假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021341889400832, 'admin', '2019-01-19 20:07:48', 0, 'admin', '2019-04-01 23:56:10', '', 99020862912466944, 5.00, 0, '陪产假', '陪产假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021382393794560, 'admin', '2019-01-19 20:07:58', 0, 'admin', '2019-04-01 23:56:14', '', 99020862912466944, 6.00, 0, '婚假', '婚假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021437171404800, 'admin', '2019-01-19 20:08:11', 0, 'admin', '2019-04-01 23:56:18', '', 99020862912466944, 7.00, 0, '例假', '例假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021497724571648, 'admin', '2019-01-19 20:08:25', 0, 'admin', '2019-04-01 23:56:23', '', 99020862912466944, 8.00, 0, '丧假', '丧假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (99021556704874496, 'admin', '2019-01-19 20:08:39', 0, 'admin', '2019-04-01 23:56:27', '', 99020862912466944, 9.00, 0, '哺乳假', '哺乳假', NULL, NULL, NULL, NULL);
INSERT INTO `t_dict_data` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `dict_id`, `sort_order`, `status`, `title`, `value`, `create_id`, `update_id`, `type`, `type_code`) VALUES (125170157323554816, 'admin', '2019-04-01 23:53:52', 0, 'admin', '2019-04-01 23:53:52', '', 75383353938808832, 3.00, 0, '工作流', '工作流', NULL, NULL, NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_file_category` (`id`, `create_by`, `create_id`, `create_time`, `del_flag`, `update_by`, `update_id`, `update_time`, `is_parent`, `parent_id`, `parent_title`, `sort_order`, `title`) VALUES (1, 'admin', NULL, '2022-02-28 09:43:16', '0', NULL, NULL, '2022-02-28 09:43:16', '0', '0', '一级目录', '2', '测试');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`, `create_id`, `update_id`) VALUES (1, NULL, '2022-02-27 01:19:18', 0, NULL, '2022-02-27 01:19:18', 139, '127.0.0.1', '未知', '账号登录', '{\"password\":\"***\",\"code\":\"wkwg\",\"saveLogin\":\"true\",\"mobile\":\"\",\"captchaId\":\"a6583a9491634004a39539a8048ecacc\",\"username\":\"admin\"}', 'POST', '/api/legion/auth/login', 'admin', 1, 'Chrome 98.0.4758.80 | Mac OSX | PC端', NULL, NULL);
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`, `create_id`, `update_id`) VALUES (2, NULL, '2022-02-27 01:50:45', 0, NULL, '2022-02-27 01:50:45', 245, '127.0.0.1', '未知', '账号登录', '{\"password\":\"***\",\"code\":\"43vk\",\"saveLogin\":\"true\",\"mobile\":\"\",\"captchaId\":\"370cac81005a4376bc5d89f6db4b5c3b\",\"username\":\"admin\"}', 'POST', '/api/legion/auth/login', 'admin', 1, 'Chrome 98.0.4758.80 | Mac OSX | PC端', NULL, NULL);
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`, `create_id`, `update_id`) VALUES (3, NULL, '2022-02-27 02:00:36', 0, NULL, '2022-02-27 02:00:36', 176, '127.0.0.1', '未知', '账号登录', '{\"password\":\"***\",\"code\":\"gxgy\",\"saveLogin\":\"true\",\"mobile\":\"\",\"captchaId\":\"b23535733e0446209e24bfdd50870b49\",\"username\":\"admin\"}', 'POST', '/api/legion/auth/login', 'admin', 1, 'Chrome 98.0.4758.80 | Mac OSX | PC端', NULL, NULL);
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`, `create_id`, `update_id`) VALUES (4, NULL, '2022-02-27 23:37:39', 0, NULL, '2022-02-27 23:37:39', 219, '127.0.0.1', '未知', '账号登录', '{\"password\":\"***\",\"code\":\"72ob\",\"saveLogin\":\"true\",\"mobile\":\"\",\"captchaId\":\"5a668e8b7cec4e9f941a4fa518081fa6\",\"username\":\"admin\"}', 'POST', '/api/legion/auth/login', 'admin', 1, 'Chrome 98.0.4758.80 | Mac OSX | PC端', NULL, NULL);
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`, `create_id`, `update_id`) VALUES (5, NULL, '2022-02-27 23:49:12', 0, NULL, '2022-02-27 23:49:12', 219, '127.0.0.1', '未知', '账号登录', '{\"password\":\"***\",\"code\":\"8yzo\",\"saveLogin\":\"true\",\"mobile\":\"\",\"captchaId\":\"6d3a677fed184159b6e7961171b0050c\",\"username\":\"admin\"}', 'POST', '/api/legion/auth/login', 'admin', 1, 'Chrome 98.0.4758.80 | Mac OSX | PC端', NULL, NULL);
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`, `create_id`, `update_id`) VALUES (6, NULL, '2022-02-28 00:20:42', 0, NULL, '2022-02-28 00:20:42', 359, '127.0.0.1', '未知', '账号登录', '{\"password\":\"***\",\"code\":\"jojs\",\"saveLogin\":\"true\",\"mobile\":\"\",\"captchaId\":\"e10988dc71b1462c963d620cbc8b36e7\",\"username\":\"admin\"}', 'POST', '/api/legion/auth/login', 'admin', 1, 'Chrome 98.0.4758.80 | Mac OSX | PC端', NULL, NULL);
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`, `create_id`, `update_id`) VALUES (7, NULL, '2022-02-28 09:36:48', 0, NULL, '2022-02-28 09:36:48', 322, '127.0.0.1', '未知', '账号登录', '{\"password\":\"***\",\"code\":\"ndqu\",\"saveLogin\":\"true\",\"mobile\":\"\",\"captchaId\":\"d2d272435a7f42a8a6c3947eec18ae6a\",\"username\":\"admin\"}', 'POST', '/api/legion/auth/login', 'admin', 1, 'Chrome 98.0.4758.80 | Mac OSX | PC端', NULL, NULL);
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`, `create_id`, `update_id`) VALUES (8, NULL, '2022-02-28 09:47:59', 0, NULL, '2022-02-28 09:47:59', 303, '127.0.0.1', '未知', '账号登录', '{\"password\":\"***\",\"code\":\"pq9n\",\"saveLogin\":\"true\",\"mobile\":\"\",\"captchaId\":\"bd5e1983bc794a79ab2e6cf2dd465632\",\"username\":\"admin\"}', 'POST', '/api/legion/auth/login', 'admin', 1, 'Chrome 98.0.4758.80 | Mac OSX | PC端', NULL, NULL);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `t_message` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `create_send`, `title`, `type`, `content`, `is_template`, `create_id`, `update_id`) VALUES (43615268366192640, 'admin', '2018-08-19 22:43:51', 0, 'admin', '2021-01-01 14:49:39', b'1', '欢迎您注册账号使用 点我查看使用须知', '系统公告', '<p style=\"text-align: center;\">是很棒的Web前后端分离开发平台，开源版本请遵循GPL v3.0开源协议，不得闭源，商用需求请联系作者签署授权协议。</p><p style=\"text-align: center;\">捐赠获取完整版：<a href=\"http://xpay.exrick.cn/pay?legion\" target=\"_blank\" style=\"background-color: rgb(255, 255, 255);\">立即去捐赠获取</a></p><p style=\"text-align: center;\"><img src=\"https://i.loli.net/2018/08/24/5b801c8652227.png\" style=\"max-width:150px;\"><br></p><p style=\"text-align: center;\">手机扫一扫支付</p><p style=\"text-align: center;\">获取商用授权：<a href=\"http://wpa.qq.com/msgrd?v=3&amp;uin=1012139570&amp;site=qq&amp;menu=yes\" target=\"_blank\" style=\"background-color: rgb(255, 255, 255);\">立即联系作者获取商用授权</a></p>', b'0', NULL, NULL);
INSERT INTO `t_message` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `create_send`, `title`, `type`, `content`, `is_template`, `create_id`, `update_id`) VALUES (1352138048674074624, 'admin', '2021-01-21 14:16:47', 0, 'admin', '2021-01-22 01:35:38', b'0', '您收到了一个新的委托转办的“${processName}”任务，申请人：${applyer}', '工作流', '<p>${nickname}您好，<span style=\"font-size: 1em;\">您收到了一个新的</span>委托转办的“${processName}”任务，申请人：${nickname}，赶快去系统“工作流程-我的待办”中查看处理吧！</p>', b'1', NULL, NULL);
INSERT INTO `t_message` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `create_send`, `title`, `type`, `content`, `is_template`, `create_id`, `update_id`) VALUES (1352243408286126080, 'admin', '2021-01-21 21:15:27', 0, 'admin', '2021-01-22 01:35:21', b'0', '您收到了一条新的“${processName}”待办任务，申请人：${applyer}', '工作流', '<p>${nickname}您好，您收到了一条新的“${processName}”待办任务，申请人：${applyer}，赶快去“工作流程-我的待办”处理查看吧<br></p>', b'1', NULL, NULL);
INSERT INTO `t_message` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `create_send`, `title`, `type`, `content`, `is_template`, `create_id`, `update_id`) VALUES (1352244242726129664, 'admin', '2021-01-21 21:18:46', 0, 'admin', '2021-01-22 01:34:57', b'0', '您申请的“${processName}”任务已审批通过', '工作流', '<p>${nickname}您好，您申请的“${processName}”任务已审批通过，赶快去“工作流程-我的申请”处理查看吧<br></p>', b'1', NULL, NULL);
INSERT INTO `t_message` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `create_send`, `title`, `type`, `content`, `is_template`, `create_id`, `update_id`) VALUES (1352304101387538432, 'admin', '2021-01-22 01:16:37', 0, 'admin', '2021-01-22 01:33:48', b'0', '${nickname}您好，您申请的“${processName}”任务已被驳回', '工作流', '<p>${nickname}您好，您申请的“${processName}”任务已被驳回，赶快去“工作流程-我的申请”处理查看吧<br></p>', b'1', NULL, NULL);
COMMIT;
...
INSERT INTO `t_user` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `address`, `avatar`, `description`, `email`, `mobile`, `nickname`, `password`, `sex`, `status`, `type`, `username`, `del_flag`, `department_id`, `street`, `pass_strength`, `department_title`, `birth`, `update_id`, `create_id`) VALUES (682265633886209, '', '2018-04-30 23:28:42', 'admin', '2020-04-12 13:57:08', '北京市,市辖区,东城区', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', '', 'Exrick@exrick.cn', '18782059032', 'exrick', '$2a$10$PS04ecXfknNd3V8d.ymLTObQciapMU4xU8.GADBZZsuTZr7ymnagy', '女', -1, 0, 'Exrick', 0, 40343262766043136, '', '弱', '成都分部', '2020-04-13 00:00:00.000000', NULL, NULL);
INSERT INTO `t_user` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `address`, `avatar`, `description`, `email`, `mobile`, `nickname`, `password`, `sex`, `status`, `type`, `username`, `del_flag`, `department_id`, `street`, `pass_strength`, `department_title`, `birth`, `update_id`, `create_id`) VALUES (4363087427670016, '', '2018-05-03 15:09:42', 'admin', '2020-04-18 22:24:08', '北京市,市辖区,东城区', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', '', 'test@exrick.cn', '18782059033', '游客1', '$2a$10$PS04ecXfknNd3V8d.ymLTObQciapMU4xU8.GADBZZsuTZr7ymnagy', '男', 0, 0, 'test', 0, 40343262766043136, '', '弱', '成都分部', '2020-04-28 00:00:00.000000', NULL, NULL);
INSERT INTO `t_user` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `address`, `avatar`, `description`, `email`, `mobile`, `nickname`, `password`, `sex`, `status`, `type`, `username`, `del_flag`, `department_id`, `street`, `pass_strength`, `department_title`, `birth`, `update_id`, `create_id`) VALUES (16739222421508096, '', '2018-06-06 18:48:02', 'admin', '2020-04-27 22:01:24', '北京市,市辖区,东城区', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', '', 'test2@exrick.cn', '18782059034', '游客2', '$2a$10$PS04ecXfknNd3V8d.ymLTObQciapMU4xU8.GADBZZsuTZr7ymnagy', '男', 0, 0, 'test2', 0, 40322777781112832, '', '弱', '总部', '2020-04-23 00:00:00.000000', NULL, NULL);
COMMIT;
