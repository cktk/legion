...
import com.esmooc.legion.open.service.QuestionService;
...
public class QuestionController {
    ...
    public Result saveQuestion(@RequestBody ExamQuestion examQuestion) {
        /**
         *  校验，类别id必传
         */
        if (null == examQuestion) {
    ...
    public Result getQuestionById(String id) {
        ...
        Map m = questionService.getQuestionById(id);
    ...
    public Result putQuestion(@RequestBody ExamQuestion examQuestion) {
        // 校验数据
        if (null == examQuestion) {
            return ResultUtil.error("参数错误");
        }
    ...
    public Result createQuestionBank(@RequestBody ExamQuestionBank examQuestionBank) {
        /**
         *  校验， 题库名称、类别不能为空
         */
        ...
        if (null == examQuestionBank.getTitle() || "".equals(examQuestionBank.getTitle())) {
            return ResultUtil.error("参数错误");
        }
