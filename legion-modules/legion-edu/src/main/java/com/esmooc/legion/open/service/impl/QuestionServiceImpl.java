...
public class QuestionServiceImpl implements QuestionService {
    ...
    public void saveQuestion(ExamQuestion examQuestion) {
        ...
        if (null == examQuestion.getId() || "".equals(examQuestion.getId())) {
            examQuestion.setId(BaseUtils.getUUID());
            // 新增
            questionMapper.saveQuestion(examQuestion);
        } else {
            // 修改
            questionMapper.updateQuestion(examQuestion);
        }
    }

    @Override
    public Map getQuestionById(String id) {
        Map m = new HashMap<>();
     ...
     */
    @Override
    public Map createQuestionBank(ExamQuestionBank examQuestionBank) {
        Map m = new HashMap<>();
