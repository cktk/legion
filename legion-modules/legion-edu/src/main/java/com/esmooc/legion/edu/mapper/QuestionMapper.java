...
@Mapper
public interface QuestionMapper  extends BaseMapper<ExamQuestion> {
    IPage<ExamQuestion> questionListByClazzId(@Param("exam") ExamQuestion examQuestion, @Param("page") Page page);
    ...
    IPage<ExamQuestionBank> selectQuestionBank(@Param("exam") ExamQuestionBank examQuestionBank,@Param("page") Page page);
