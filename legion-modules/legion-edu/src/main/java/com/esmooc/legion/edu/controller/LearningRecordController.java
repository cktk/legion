...
public class LearningRecordController {
    ...
    public Result<IPage<LearningRecordVO>> list(LearningRecordVO bizLearningRecord, PageVo pageVo) {
        ...
        IPage<LearningRecordVO> list = learningRecordService.selectLearningRecordList(bizLearningRecord,  PageUtil.initPage(pageVo));
    ...
    public List<LearningRecordVO> export(LearningRecordVO bizLearningRecord, PageVo page) {
        bizLearningRecord.setDelFlag(Constants.ISNOTDELETE);
        IPage<LearningRecordVO> list = learningRecordService.selectLearningRecordList(bizLearningRecord,  PageUtil.initPage(page));
