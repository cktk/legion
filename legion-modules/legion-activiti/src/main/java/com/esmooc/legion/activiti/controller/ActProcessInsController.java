...
import com.esmooc.legion.activiti.vo.HistoricProcessInsVo;
import com.esmooc.legion.activiti.vo.ProcessInsVo;
...
public class ActProcessInsController {
    ...
    public void getHighlightImg(@ApiParam("流程实例id") @PathVariable String id,
        ...
        try {
            ...
            throw new LegionException("读取流程图片失败");
        }
    }
