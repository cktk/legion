package com.esmooc.legion.activiti.controller.business;
...
@Api(tags = "请假申请接口")
@Transactional
@RequestMapping(value = "/legion/leave")
public class LeaveController extends LegionBaseController<Leave, String> {
