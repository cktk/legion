...
import com.esmooc.legion.activiti.controller.modeler.DefaultProcessDiagramGenerator;
import com.esmooc.legion.activiti.entity.*;
import com.esmooc.legion.activiti.entity.*;
import com.esmooc.legion.activiti.properties.ActivitiExtendProperties;
import com.esmooc.legion.activiti.service.*;
import com.esmooc.legion.activiti.service.*;
...
@RestController
@Api(tags = "流程定义管理接口")
@RequestMapping("/legion/actProcess")
@Transactional
public class ActProcessController {
    ...
    public Result<ActProcess> getByCondition(@PathVariable String key) {
        ...
        return ResultUtil.data(actProcess);
    }
    ...
    public void exportResource(@ApiParam("流程定义id") @RequestParam String id,
        ...
        if (ActivitiConstant.RESOURCE_TYPE_XML.equals(type)) {
            ...
            throw new LegionException("类型type不正确");
        }
        ...
        try {
            ...
            throw new LegionException("导出部署流程资源失败");
        }
    }
