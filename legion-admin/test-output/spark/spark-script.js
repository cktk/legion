...
jQuery, window.app = {
    name: "",
    author: "",
    breakpoint: {mobile: 576, tablet: 767, laptop: 992, desktop: 1440},
    colors: {
        primary: "#6569df",
        success: "#24d5d8",
        info: "#04a1f4",
    ...
    var i = {
        init: function () {
            e(".side-nav .side-nav-menu li a").on("click", function (n) {
                ...
                if (e(".side-nav-backdrop").length) e(".side-nav-backdrop").remove(); else {
    ...
    var i = {
        init: function () {
            e(".quick-view-toggler").on("click", function (n) {
                if (e(".quick-view-backdrop").length) e(".quick-view-backdrop").remove(); else {
    ...
    window.misc = i
}(jQuery), jQuery, sideNav.init(), quickView.init(), aside.init(), header.init(), cards.init(), tables.init(), misc.init(), function (e, n) {
    var i = {
        init: function () {
